...
After that, you can run the program using
	...
	.build/debug/GtkListViewDemo

A 'Book List Demo' window should appear that contains a list view.  To exit the program, click the close button or press Control-C in the Terminal window.
